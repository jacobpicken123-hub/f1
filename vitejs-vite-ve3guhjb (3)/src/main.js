...
app.innerHTML = `
  ...
  <div class="actions">
  <button id="homeBtn" class="btn home-btn">🏠 Home</button>
    <!-- Calendar Dropdown -->
    <div class="dropdown">
...
<section id="homeView" class="panel home-panel" style="display:block;">
  <div class="home-hero">
    <div class="home-hero-content">
      <div class="f1-logo-large">
        <div class="logo-text">F1</div>
        <div class="logo-line"></div>
      </div>
      <h1 class="home-title">Fantasy Race Tracker</h1>
      <p class="home-subtitle">Track races, manage drivers, view standings & more</p>
    </div>
  </div>

  <div class="home-grid">
    <div class="home-card primary-card" data-view="race">
      <div class="card-icon">🏁</div>
      <h2>Race Results</h2>
      <p>Enter and manage race results, pole positions, and fastest laps</p>
      <div class="card-arrow">→</div>
    </div>

    <div class="home-card" data-view="qualifying">
      <div class="card-icon">⏱️</div>
      <h2>Qualifying</h2>
      <p>Record qualifying positions and lap times for each race</p>
      <div class="card-arrow">→</div>
    </div>

    <div class="home-card championship-card" data-view="standings">
      <div class="card-icon">🏆</div>
      <h2>Driver Standings</h2>
      <p>View complete championship standings and race-by-race results</p>
      <div class="card-arrow">→</div>
    </div>

    <div class="home-card" data-view="constructors">
      <div class="card-icon">🏁</div>
      <h2>Constructors</h2>
      <p>Team championship standings and points breakdown</p>
      <div class="card-arrow">→</div>
    </div>

    <div class="home-card stats-card" data-view="driverStats">
      <div class="card-icon">📊</div>
      <h2>Driver Statistics</h2>
      <p>Wins, podiums, poles, and performance analytics</p>
      <div class="card-arrow">→</div>
    </div>

    <div class="home-card" data-view="teammates">
      <div class="card-icon">🤝</div>
      <h2>Teammate H2H</h2>
      <p>Head-to-head teammate comparison and statistics</p>
      <div class="card-arrow">→</div>
    </div>

    <div class="home-card records-card" data-view="records">
      <div class="card-icon">📈</div>
      <h2>All-Time Records</h2>
      <p>Historic wins, championships, and career achievements</p>
      <div class="card-arrow">→</div>
    </div>

    <div class="home-card" data-view="drivers">
      <div class="card-icon">👤</div>
      <h2>Drivers & Teams</h2>
      <p>Manage driver profiles, team info, and photos</p>
      <div class="card-arrow">→</div>
    </div>

    <div class="home-card" data-view="calendar">
      <div class="card-icon">📅</div>
      <h2>Calendar Manager</h2>
      <p>Edit race schedule, reorder events, and update flags</p>
      <div class="card-arrow">→</div>
    </div>

    <div class="home-card season-card" data-view="seasons">
      <div class="card-icon">💾</div>
      <h2>Saved Seasons</h2>
      <p>View, load, and manage previous championship seasons</p>
      <div class="card-arrow">→</div>
    </div>
  </div>
  ...
  <div class="home-footer">
    <div class="home-footer-content">
      <p>F1 Fantasy Tracker • Real-time Sync • 100% Offline-Ready</p>
    </div>
  </div>
</section>
      <!-- Race view -->
